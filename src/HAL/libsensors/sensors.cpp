...
{
    mSensors[dmt] = new DmtSensor();
    mPollFds[dmt].fd = mSensors[dmt]->getFd();
    mPollFds[dmt].events = POLLIN;
    mPollFds[dmt].revents = 0;

/******************************************************************************
 *
 * $Id: AKEC_Version.h 219 2011-07-05 23:17:38Z yamada.rj $
 *
 * -- Copyright Notice --
 *
 ...
 *
 ******************************************************************************/
#ifndef AKEC_INC_VERSION_H
#define AKEC_INC_VERSION_H

#include "AKEC_Device.h"

/***** Prototype of function **************************************************/
AKLIB_C_API_START
int16 AKEC_GetVersion_Major(void);
int16 AKEC_GetVersion_Minor(void);
int16 AKEC_GetVersion_Revision(void);
int16 AKEC_GetVersion_DateCode(void);
int16 AKEC_GetVersion_Variation(void);
AKLIB_C_API_END
